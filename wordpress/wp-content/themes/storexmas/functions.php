...
$storexmas_header_display = $storexmas_settings['storexmas_header_display'];

	if ($storexmas_header_display == 'header_logo' || $storexmas_header_display == 'header_text' || $storexmas_header_display == 'show_both') {

	echo '<div id="site-branding">';

	if ($storexmas_header_display == 'header_logo' || $storexmas_header_display == 'show_both') {

		storexmas_the_custom_logo();

	}

	if ($storexmas_header_display == 'header_text' || $storexmas_header_display == 'show_both') {
